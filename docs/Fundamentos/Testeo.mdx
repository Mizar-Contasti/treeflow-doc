...
La prueba y depuración de tus Árboles es una parte esencial del desarrollo de chatbots en TreeFlow. Esta sección te guiará a través de las herramientas y técnicas disponibles para asegurar que tu Árbol funcione correctamente.

## Consola de Pruebas

TreeFlow incluye una consola de pruebas integrada que te permite interactuar con tu Árbol en tiempo real y ver cómo responde a diferentes entradas.
...
TreeFlow guarda un historial de todas las conversaciones con tu Árbol, lo que te permite:
