...
- Explora ejemplos prácticos en la sección de [Tutoriales](/docs/Tutoriales/Introduccion)
- Consulta la documentación de la API para entender los formatos de datos
