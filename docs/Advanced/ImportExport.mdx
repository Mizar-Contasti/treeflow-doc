...
Treeflow proporciona herramientas potentes para importar y exportar datos, permitiéndote respaldar tus Trees (árboles), compartirlos entre entornos, o migrar desde otras plataformas. Esta guía explica las diferentes opciones disponibles para la gestión de datos en Treeflow.
...
Treeflow mantiene un historial de cambios para cada Tree:
