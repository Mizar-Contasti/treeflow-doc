...
La integración nativa con WhatsApp Business está planificada para el ciclo de desarrollo de 2027. La siguiente documentación refleja la arquitectura técnica planificada. Por ahora, te sugerimos utilizar los **Fertilizantes** (Webhooks) para enlazar tu árbol a WhatsApp mediante middlewares de terceros.
...
Esta integración estará disponible en 2027. Mantente al día con nuestras actualizaciones.
