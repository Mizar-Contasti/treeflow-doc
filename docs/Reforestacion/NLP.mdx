...
Las técnicas avanzadas de NLP están completamente integradas en TreeFlow v0.4, potenciando tanto el reconocimiento de intenciones como la generación de contenido en el pipeline de Reforestación.
:::
...
la frase, y se define por **filas** —cada fila, una forma válida de decir lo mismo—:
...
Los dos puntos nombran el parámetro: `@Productos:producto` guarda la hoja `Productos`
bajo el nombre `producto`. Ver [Hojas Compuestas](/docs/Fundamentos/Hojas#2-hojas-compuestas)
para el detalle.
