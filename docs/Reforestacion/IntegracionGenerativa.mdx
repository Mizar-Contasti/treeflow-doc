...
La integración generativa está operativa. La ejecuta el **Agente Constructor IA** dentro del backend principal, y trabaja con el proveedor de modelos que tú configures —Anthropic, OpenAI, Gemini, Groq, Cerebras, xAI, Mistral, OpenRouter u Ollama en local— usando tu propia clave de API.
:::
