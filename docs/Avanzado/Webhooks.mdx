...
Los **Webhooks** en Treeflow permiten conectar tu Tree (árbol) con servicios externos, ampliando significativamente las capacidades de tu chatbot determinista.
...
Cuando esta Branch se active durante una conversación, Treeflow enviará automáticamente una solicitud al endpoint configurado.
